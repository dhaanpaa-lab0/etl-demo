...
class EtlDbConfig:
    ...
    def __init__(self, env_name: str = None):
        ...
        self.db_type = self.get_config_var("TYPE", "postgres+psycopg3")
...
class EtlEnvironment:
    ...
    def check_folders(self):
        """
        Creates system folders for ETL operations if they don't exist.

        :param sys_root: Root directory path where system folders will be created.
